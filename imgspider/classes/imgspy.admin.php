...
class IMGSPY_Admin extends IMGSPY_Base
{
    ...
    public static function txt_log($msg)
    {
        ...
        error_log('[' . current_time('mysql') . ']' . $msg . "\n", 3, IMGSPY_PATH . '/#log/' . current_time('Ym') . '.log');
    }
    ...
    public static function save_post($post_ID, $post, $update)
    {
        ...
        $post_data = self::param('data');
        if ($post_data && isset($post_data['wp_autosave'])) {
            return;
        }
    ...
    public static function admin_head()
    {
        ...
        wp_add_inline_script(
            ...
            'var imgspy_cnf=' . wp_json_encode(WB_IMGSPY_Conf::opt()) . ',
